...
#
	...
	INSERT INTO {$db_prefix}calendar_holidays (title, event_date) VALUES ('Новый год', '0004-01-01');
	INSERT INTO {$db_prefix}calendar_holidays (title, event_date) VALUES ('Рождество', '0004-01-07');
	INSERT INTO {$db_prefix}calendar_holidays (title, event_date) VALUES ('День защитника Отечества', '0004-02-23');
	INSERT INTO {$db_prefix}calendar_holidays (title, event_date) VALUES ('Международный женский день', '0004-03-08');
	INSERT INTO {$db_prefix}calendar_holidays (title, event_date) VALUES ('День смеха', '0004-04-01');
	INSERT INTO {$db_prefix}calendar_holidays (title, event_date) VALUES ('День космонавтики', '0004-04-12');
	INSERT INTO {$db_prefix}calendar_holidays (title, event_date) VALUES ('Международный день охраны труда', '0004-04-28');
	INSERT INTO {$db_prefix}calendar_holidays (title, event_date) VALUES ('День пожарной охраны', '0004-04-30');
	INSERT INTO {$db_prefix}calendar_holidays (title, event_date) VALUES ('Праздник Весны и Труда', '0004-05-01');
	INSERT INTO {$db_prefix}calendar_holidays (title, event_date) VALUES ('День радио', '0004-05-07');
	INSERT INTO {$db_prefix}calendar_holidays (title, event_date) VALUES ('День Победы', '0004-05-09');
	INSERT INTO {$db_prefix}calendar_holidays (title, event_date) VALUES ('Международный день защиты детей', '0004-06-01');
	INSERT INTO {$db_prefix}calendar_holidays (title, event_date) VALUES ('День России', '0004-06-12');
	INSERT INTO {$db_prefix}calendar_holidays (title, event_date) VALUES ('День молодёжи', '0004-06-27');
	INSERT INTO {$db_prefix}calendar_holidays (title, event_date) VALUES ('День Воздушно-десантных войск', '0004-08-02');
	INSERT INTO {$db_prefix}calendar_holidays (title, event_date) VALUES ('День знаний', '0004-09-01');
	INSERT INTO {$db_prefix}calendar_holidays (title, event_date) VALUES ('Всемирный день туризма', '0004-09-27');
	INSERT INTO {$db_prefix}calendar_holidays (title, event_date) VALUES ('День учителя', '0004-10-05');
	INSERT INTO {$db_prefix}calendar_holidays (title, event_date) VALUES ('День народного единства', '0004-11-04');
	INSERT INTO {$db_prefix}calendar_holidays (title, event_date) VALUES ('День Конституции Российской Федерации', '0004-12-12');
...
INSERT INTO {$db_prefix}settings (variable, value) VALUES ('admin_features', 'cd,cp,ml,rg,sp');
...
INSERT INTO {$db_prefix}spiders (id_spider, spider_name, user_agent, ip_info) VALUES (20, 'Yandex', 'Mozilla/5.0 (compatible; YandexBot/3.0; +http://yandex.com/bots)', '');
INSERT INTO {$db_prefix}spiders (id_spider, spider_name, user_agent, ip_info) VALUES (21, 'Nigma', 'Mozilla/5.0 (compatible; Nigma.ru/3.0; crawler@nigma.ru)', '');
INSERT INTO {$db_prefix}spiders (id_spider, spider_name, user_agent, ip_info) VALUES (22, 'Sape BOT', 'SAPE.BOT is watching you!', '');
INSERT INTO {$db_prefix}spiders (id_spider, spider_name, user_agent, ip_info) VALUES (23, 'Sputnik Bot', 'Mozilla/5.0 (compatible; SputnikBot/2.3; +http://corp.sputnik.ru/webmaster)', '');
INSERT INTO {$db_prefix}spiders (id_spider, spider_name, user_agent, ip_info) VALUES (24, 'Mail.RU Bot', 'Mozilla/5.0 (compatible; Mail.RU_Bot/2.0; +http://go.mail.ru/help/robots', '');
INSERT INTO {$db_prefix}spiders (id_spider, spider_name, user_agent, ip_info) VALUES (25, 'Mail.RU Bot', 'Mozilla/5.0 (compatible; Mail.RU_Bot/Fast/2.0; +http://go.mail.ru/help/robots)', '');
...
INSERT INTO {$db_prefix}themes (id_member, id_theme, variable, value) VALUES (-1, 1, 'popup_messages', '1');
...
INSERT INTO {$db_prefix}themes (id_member, id_theme, variable, value) VALUES (-1, 1, 'calendar_start_day', '1');
# --------------------------------------------------------
